...
const products = [
  ...
  },
  {
    ...
    bg: "linear-gradient(155deg,#ddd6c6,#bdb6a4)",
    pos: "center top",
  },
  {
    idx: "04",
    ...
    bg: "linear-gradient(155deg,#cdd0c4,#9ca08f)",
    pos: "center top",
  },
  {
    idx: "05",
    ...
    vendor: "Le Marcheur",
    isNew: false,
    img: "https://buffalojackson.com/cdn/shop/articles/ryder-reserve-bison-leather-duffloe-bag-2_900x900_crop_center_095727c4-c15d-4d19-885b-2337c6416986_1400x.progressive.webp.jpg?v=1708707024",
    bg: "linear-gradient(155deg,#ded6c9,#c0b29c)",
    pos: "center",
  },
  {
    idx: "06",
  ...
  },
  {
    ...
    bg: "linear-gradient(155deg,#cdc6b6,#9ca08f)",
    pos: "center top",
  },
];
      ...
      <main id="top" className="subpage">
        ...
        >
          <div className="col-slider__track">
            ...
            <div className="col-slide is-active">
              <div
                className="col-slide__bg"
                style={{
                  backgroundImage:
                    "url('https://images.pexels.com/photos/1536619/pexels-photo-1536619.jpeg?auto=compress&cs=tinysrgb&w=1400&h=1900&fit=crop')",
                }}
              ></div>
              <div className="col-slide__overlay"></div>
              <div className="col-slide__content">
                <span className="col-slide__tag">Women&apos;s Edit</span>
                <h2 className="col-slide__title">
                  Dressed for
                  <br />
                  <em>every mood.</em>
                </h2>
                <p className="col-slide__desc">
                  Light layers and clean silhouettes for the new season.
                </p>
                <a href="/product" className="btn btn--line col-slide__cta">
            ...
            <div className="col-slide">
              <div
                ...
                style={{
                  backgroundImage:
                    "url('https://images.pexels.com/photos/2220316/pexels-photo-2220316.jpeg?auto=compress&cs=tinysrgb&w=1400&h=1900&fit=crop')",
                }}
              ></div>
              <div className="col-slide__overlay"></div>
              <div className="col-slide__content">
                ...
                <p className="col-slide__desc">
                  Forty core styles arriving now from Paris ateliers.
                </p>
                <a href="/product" className="btn btn--line col-slide__cta">
            ...
            <div className="col-slide">
              <div
                ...
                style={{
                  backgroundImage:
                    "url('https://img.magnific.com/free-photo/young-handsome-man-choosing-clothes-shop_1303-19720.jpg?semt=ais_hybrid&w=740&q=80')",
                }}
              ></div>
              <div className="col-slide__overlay"></div>
              <div className="col-slide__content">
                ...
                <p className="col-slide__desc">
                  Easy essentials and elevated streetwear, built clean.
                </p>
                <a href="/product" className="btn btn--line col-slide__cta">
            ...
            <div className="col-slide">
              <div
                ...
                style={{
                  backgroundImage:
                    "url('https://images.pexels.com/photos/2613260/pexels-photo-2613260.jpeg?auto=compress&cs=tinysrgb&w=1400&h=1900&fit=crop')",
                }}
              ></div>
              <div className="col-slide__overlay"></div>
              <div className="col-slide__content">
                ...
                <p className="col-slide__desc">
                  Real leather goods made to outlast the season.
                </p>
                <a href="/product" className="btn btn--line col-slide__cta">
          ...
          {/* Arrows */}
          <button
            className="col-slider__arrow col-slider__arrow--prev"
            id="colSliderPrev"
          ...
          <button
            className="col-slider__arrow col-slider__arrow--next"
            id="colSliderNext"
          ...
          <div className="col-slider__bars" aria-hidden="true">
            <button className="col-sbar is-active" data-slide="0">
              <div className="col-sbar__fill"></div>
            </button>
            <button className="col-sbar" data-slide="1">
              <div className="col-sbar__fill"></div>
            </button>
            <button className="col-sbar" data-slide="2">
              <div className="col-sbar__fill"></div>
            </button>
            <button className="col-sbar" data-slide="3">
              <div className="col-sbar__fill"></div>
            </button>
          </div>
        </section>
        ...
        <div className="toolbar">
          ...
          >
            ...
            <span className="filter-count" id="filterCount" aria-live="polite">
              9 styles
            </span>
          </div>
        ...
        <section className="shop shop--collection">
          ...
          <div className="loadmore-wrap">
            <button
              className="btn btn--line loadmore"
              id="loadmore"
              data-magnetic=""
            >
              <span>Load more</span>
